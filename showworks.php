...
if(isset($_POST['MarkAsFinished'])){
	$_SESSION['WorkId']=$_POST['WorkId'];
	header('Location: attends.php');
}
if(isset($_POST['DeleteWork'])){
	$WorkId=$_POST['WorkId'];
	$query3="DELETE FROM Work WHERE WorkId='$WorkId'";
...
<td align="center"><h3><input type="submit" name="DeleteWork" value="DELETE"></h3></td>
<td align="center"><h3><input type="submit" name="EditWork" value="EDIT"></h3></td>
<td align="center"><h3><input type="submit" name="MarkAsFinished" value="MARK AS FINISHED"></h3></td>
</form>
